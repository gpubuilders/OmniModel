...
"""
Object Grounding with Qwen3-Omni using local API
...
def process_object_grounding_message(image_file_path, object_description):
    """
    Process an object grounding message
    """
    # Load image as base64
    image_base64 = load_local_image_as_base64(image_file_path)
    
    # Prepare user message with image and object description
    user_message = {
        "role": "user",
        "content": [
            {
            ...
            {
                "type": "text",
                "text": f"Locate the object: {object_description}"
            }
        ]
    }
...
if __name__ == "__main__":
    ...
    image_urls = [
        "https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen3-Omni/cookbook/grounding1.jpeg",
    ...
    # Example 1: Locate bird
    print("--- Example 1: Locate bird ---")
    image_path = image_paths[0]
    object_description = "bird"
    ...
    # Prepare the object grounding message with local file
    messages = process_object_grounding_message(image_path, object_description)
    ...
    # Example 2: Locate person on motorcycle
    print("--- Example 2: Locate person riding motorcycle ---")
    image_path = image_paths[1]
    object_description = "A person riding a motorcycle while wearing a helmet."
