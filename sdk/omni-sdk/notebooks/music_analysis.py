...
# ### Music Analysis with Qwen3-Omni
...
audio_path = "https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen3-Omni/cookbook/音乐风格-调性.mp3"
...
audio_path = "https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen3-Omni/cookbook/37573.mp3"
...
messages = [
    {
        ...
        "content": [
            {"type": "audio", "audio": audio_path},
            {"type": "text", "text": "Describe the style, rhythm, dynamics, and expressed emotions of this piece of music. Identify the instruments used and suggest possible scenarios from which this music might originate."},
        ]
    }
]
...
audio_path = "https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen3-Omni/cookbook/353349.mp3"
...
messages = [
    {
        ...
        "content": [
            {"type": "audio", "audio": audio_path},
            {"type": "text", "text": "Write an appreciative description for this piece of music. Identifying its style and genre. Analyze the collaborative patterns of different instruments in audio and explain their impact on the overall atmosphere."},
        ]
    }
]
