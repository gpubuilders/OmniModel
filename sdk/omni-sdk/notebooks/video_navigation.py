...
# ### Video Navigation with Qwen3-Omni
...
USE_AUDIO_IN_VIDEO = False
video_path = "https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen3-Omni/cookbook/video2.mp4"
...
messages = [
    {
        ...
        "content": [
            ...
            {"type": "text", "text": "If I want to stop at the window. Which direction should I take?"} 
        ]
    }
]
