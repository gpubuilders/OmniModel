...
# ### Speech Translation with Qwen3-Omni
...
messages = [
    {
        ...
        "content": [
            ...
            {"type": "text", "text": "Listen to the provided Chinese speech and produce a translation in English text."},
        ]
    }
]
...
messages = [
    {
        ...
        "content": [
            {"type": "audio", "audio": audio_path},
            {"type": "text", "text": "Listen to the provided English speech and produce a translation in Chinese text."},
        ]
    }
]
...
messages = [
    {
        ...
        "content": [
            {"type": "audio", "audio": audio_path},
            {"type": "text", "text": "Listen to the provided French speech and produce a translation in English text."},
        ]
    }
]
