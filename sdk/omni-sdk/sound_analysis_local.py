...
"""
Sound Analysis with Qwen3-Omni using local API
...
def process_sound_analysis_message(audio_file_path, analysis_prompt):
    """
    Process a sound analysis message
    """
...
if __name__ == "__main__":
    ...
    audio_urls = [
        "https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen3-Omni/cookbook/sound1.wav",
        "https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen3-Omni/cookbook/sound2.mp3",
        "https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen3-Omni/cookbook/sound3.mp3"
    ]
    audio_paths = [get_local_file_path(url) for url in audio_urls]

    # Example 1: Analyze what happened in audio
    print("--- Example 1: Analyze what happened in audio ---")
    audio_path = audio_paths[0]
    analysis_prompt = "What happened in the audio?"
    ...
    # Prepare the sound analysis message with local file
    messages = process_sound_analysis_message(audio_path, analysis_prompt)
    ...
    # Example 2: Identify sound and context
    print("--- Example 2: Identify sound and context ---")
    audio_path = audio_paths[1]
    analysis_prompt = "What is this sound? In what kind of situation might it occur?"
    ...
    # Example 3: Guess location from sound
    print("--- Example 3: Guess location from sound ---")
    audio_path = audio_paths[2]
    analysis_prompt = "Guess where I am?"
