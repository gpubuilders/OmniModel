...
"""
Speech Translation with Qwen3-Omni using local API
...
def process_speech_translation_message(audio_file_path, translation_prompt):
    """
    Process a speech translation message
    """
    # Load audio as base64
    audio_base64 = load_local_audio_as_base64(audio_file_path)
    
    # Prepare user message with audio and translation prompt
    user_message = {
        "role": "user",
        "content": [
            {
...
if __name__ == "__main__":
    ...
    print("--- Example 1: Chinese to English translation ---")
    audio_path = audio_paths[0]
    translation_prompt = "Listen to the provided Chinese speech and produce a translation in English text."
    ...
    # Prepare the speech translation message with local file
    messages = process_speech_translation_message(audio_path, translation_prompt)
    ...
    # Example 2: English to Chinese translation
    print("--- Example 2: English to Chinese translation ---")
    audio_path = audio_paths[1]
    translation_prompt = "Listen to the provided English speech and produce a translation in Chinese text."
    ...
    print("--- Example 3: French to English translation ---")
    audio_path = audio_paths[2]
    translation_prompt = "Listen to the provided French speech and produce a translation in English text."
